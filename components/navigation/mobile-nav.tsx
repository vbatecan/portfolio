...
export const MobileNav = ({ darkMode, toggleDarkMode, scrollToSection }: MobileNavProps) => {
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-t border-gray-200 dark:border-gray-700 safe-area-bottom">
