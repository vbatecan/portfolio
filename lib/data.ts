...
export const AllProjects: Project[] = [
  ...
  },
  {
    ...
    title: "Pikash",
    description:
      "High-performance, local-first personal finance companion with offline-first architecture, multi-currency support, and AI-powered expense tracking",
    category: "mobile",
    image: "/assets/pikash/cover.png?height=200&width=300",
    ...
    details: {
      overview:
        "Pikash is a high-performance, local-first personal finance companion designed for users worldwide. Built with offline-first architecture and powered by advanced state management, it provides instant transaction logging, intelligent expense tracking, and comprehensive financial analytics across multiple currencies and languages.",
      keyFeatures: [
        "Local-first, offline-ready architecture with SQLite database",
        "Instant transaction logging and zero-lag synchronization",
        "Multi-currency support (USD, EUR, GBP, JPY, PHP, IDR, and 15+ more)",
        "Fully localized in 13+ languages including English, Spanish, French, German, Japanese, Chinese, Polish, Portuguese, Turkish, Russian, Indonesian, and Filipino",
        "Conversational Chat AI with dual-engine support (cloud LLM when online, local rule-based when offline)",
        "Advanced planning with bills, subscriptions, installments, and grocery list management",
        "Budget rollover with configurable carry-forward logic",
        "Safe to Spend indicator for intelligent spending headroom calculation",
        "Cashflow forecasting with projected balance trajectories",
        "Voice input using push-to-talk recording for hands-free transaction entry",
        "Active notification listener (Android) for automatic transaction extraction from bank notifications",
        "Interactive financial analytics with 10+ custom-rendered charts",
        "Home-screen widgets for Net Worth, Recent Transactions, and Quick Actions",
        "Biometric security with device app lock and overlay concealment",
        "Personalization with custom themes, fonts, and photo backgrounds",
        "Seamless import from external finance apps",
      ],
      impact:
        "Transforms personal finance management by combining local-first performance with cloud synchronization, enabling users to track wealth instantly without internet dependency while maintaining privacy and security. The dual-engine AI assistant and multi-language support make advanced financial planning accessible globally.",
      skills: ["React 19", "TypeScript", "Vite", "Capacitor", "SQLite", "Supabase", "Tailwind CSS", "Radix UI", "Shadcn/UI", "Redux Toolkit", "TanStack Query", "Recharts", "Mobile Development"],
    },
  },
  {
    id: 23,
    title: "Solar Manila Business Manager",
    description:
      "Comprehensive business management system with real-time KPI tracking, inventory control, sales management, and role-based dashboards for solar energy operations",
    category: "web",
    image: "/assets/solar-manila/image.png?height=200&width=300",
    technologies: ["React 19", "TypeScript", "Vite", "Tailwind CSS", "Recharts", "React Router", "Supabase", "localStorage"],
    github: "#",
    live: "#",
    icon: LayoutDashboard,
    date: "2026",
    ...
    details: {
      overview:
        "Solar Manila Business Manager is a comprehensive SaaS-style business management system designed for solar energy operations. Built with a layered architecture, it provides real-time KPI tracking, inventory management, sales and expense tracking, and interactive reporting with full CRUD functionality across all modules.",
      keyFeatures: [
        "Executive Dashboard with global filters (year/month/branch/channel) and KPI grid",
        "Real-time KPI calculations: revenue, profit, margins, inventory accuracy, SLA performance",
        "Sales module with automatic stock decrements and SLA tracking",
        "Expense tracking with category breakdown and trend analysis",
        "Complete inventory management with stock-in/out history and running balance",
        "Product catalog with derived metrics: units sold, revenue, current stock",
        "Manpower productivity tracking with per-person and team analytics",
        "Comprehensive multi-level reporting: daily, monthly, and yearly trends",
        "Role-based access control (Manager, CEO, Staff, Viewer) with page-level permissions",
        "localStorage persistence with optional Supabase cloud sync",
        "Interactive Recharts visualizations: line trends, grouped bars, donut charts, heatmaps",
        "Reusable data table with search, filters, sorting, pagination, and CSV export",
        "Manager Notes for per-month annotations and action planning",
        "Auto-insights engine with deterministic rules for anomalies and issues",
        "Editable master lists for categories, channels, branches, products",
        "Business settings management: company info, fiscal year, theme customization",
        "Activity feed and audit trail for transparency and compliance",
      ],
      impact:
        "Transforms business operations for solar energy companies by consolidating all transactional data, inventory, and reporting into a single source of truth. Real-time calculations eliminate manual spreadsheet errors, while comprehensive role-based dashboards empower managers and executives to make data-driven decisions instantly.",
      skills: ["React 19", "TypeScript", "Vite", "Tailwind CSS", "Recharts", "React Router", "Supabase", "State Management", "Business Logic", "Dashboard Design"],
    },
  },
]
